...
export const BooksCard = ({ book }) => {
  return (
    <>
      <div className=" div  w-auto h-auto flex flex-col gap-5 shadow-xl text-black scale-90 hover:scale-95  ease-in-out duration-300 rounded-xl active:scale-90 overflow-hidden">
        <Link
          to={`admin/books/audiobook-detail/${book.audioBkName}`}
          target="_parent"
        >
          <img
