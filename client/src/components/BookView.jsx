...
const BookView = () => {
  ...
  const editbook = (e) => {
    ...
    axios
      .post("http://localhost:3001/edit-chp", {
        bkName,
        oldtitle: selectedChapter.title,
        oldcontent: selectedChapter.content,
        title: book.title,
  ...
  const delchp = (e) => {
    ...
    axios
      .post("http://localhost:3001/del-chp", {
        bkName,
        ...
        <div className="relative justify-center text-3xl text-center bg-zinc-900 text-white h-16">
          ...
          <div>
            ...
            <div
              ...
              } absolute mt-20 w-full h-vh backdrop-blur-sm flex justify-center z-50`}
            >
